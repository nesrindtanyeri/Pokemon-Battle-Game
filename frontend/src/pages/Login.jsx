        ...
        <div className="space-y-3">
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-6 h-6">
              <path fill="#FFC107" d="M43.61 20.083H42V20H24v8h11.313C33.797 32.477 29.465 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.066 0 5.863 1.154 8.007 3.032L37.657 8.88C34.042 5.534 29.27 4 24 4 12.954 4 4 12.954 4 24s8.954 20 20 20c10.486 0 18.914-7.743 19.838-17.68.09-.78.137-1.576.137-2.387 0-1.069-.095-2.11-.365-3.15z"></path>
              <path fill="#FF3D00" d="M6.306 14.691l6.564 4.81C15.106 15.018 19.25 13 24 13c3.066 0 5.863 1.154 8.007 3.032L37.657 8.88C34.042 5.534 29.27 4 24 4c-6.775 0-12.793 2.797-17.087 7.305l.003.002z"></path>
              <path fill="#4CAF50" d="M24 44c5.297 0 10.098-1.872 13.879-4.951l-6.517-5.364C29.614 35.587 26.933 36 24 36c-5.38 0-9.875-3.5-11.682-8.354l-6.613 5.122C10.337 39.308 16.779 44 24 44z"></path>
              <path fill="#1976D2" d="M43.61 20.083H42V20H24v8h11.313c-1.448 3.787-5.108 6.5-9.313 6.5-3.103 0-5.863-1.154-8.007-3.032l-6.564 4.81C15.106 39.982 19.25 44 24 44c6.303 0 11.638-3.286 14.761-8.161.472-.74.894-1.514 1.263-2.31.123-.286.238-.575.344-.867C41.954 32.477 43.61 27.707 43.61 20.083z"></path>
            </svg>
